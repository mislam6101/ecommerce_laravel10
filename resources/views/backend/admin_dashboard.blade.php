...
<head>
    <title>E-commerce | Flat Able Dashboard Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
        ...
        <div class="page-header">
            <div class="page-block">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-sm-auto">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('')}}/navigation/index.html"><i class="ph-duotone ph-house"></i></a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card statistics-card-1">
                    ...
                    <div class="card-body">
                        <img src="{{url('')}}/assets/images/widget/img-status-1.svg" alt="img" class="img-fluid img-bg h-100" />
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card statistics-card-1">
                    ...
                    <div class="card-body">
                        <img src="{{url('')}}/assets/images/widget/img-status-2.svg" alt="img" class="img-fluid img-bg" />
                        <div class="d-flex align-items-center">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card statistics-card-1">
                    ...
                    <div class="card-body">
                        <img src="{{url('')}}/assets/images/widget/img-status-3.svg" alt="img" class="img-fluid img-bg" />
                        <div class="d-flex align-items-center">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover m-b-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>HeadPhone</td>
                                            <td><img src="{{url('')}}/assets/images/widget/p1.jpg" alt="" class="img-20" /></td>
                                            <td>
                                                <div><label class="badge bg-light-warning">Pending</label></div>
                                            </td>
                                            <td>$10</td>
                                            <td><a href="#!"><i class="icon feather icon-edit f-16 text-success"></i></a><a class="ms-3" href="#!"><i class="feather icon-trash-2 f-16 text-danger"></i></a></td>
                                        </tr>
                                        <tr>
                                            <td>Iphone 6</td>
                                            <td><img src="{{url('')}}/assets/images/widget/p2.jpg" alt="" class="img-20" /></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Jacket</td>
                                            <td><img src="{{url('')}}/assets/images/widget/p3.jpg" alt="" class="img-20" /></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Sofa</td>
                                            <td><img src="{{url('')}}/assets/images/widget/p4.jpg" alt="" class="img-20" /></td>
                                            <td>
                                                <div><label class="badge bg-light-danger">Cancel</label></div>
                                            </td>
                                            <td>$85</td>
...
<footer class="pc-footer">
    <div class="footer-wrapper container-fluid">
        <div class="row">
            <div class="col my-1">
                <p class="m-0">Flat Able &#9829; crafted by Team <a href="https://themeforest.net/user/phoenixcoded" target="_blank">Phoenixcoded</a></p>
            </div>
...
<script src="{{url('')}}/assets/js/pages/dashboard-ecommerce.js"></script>

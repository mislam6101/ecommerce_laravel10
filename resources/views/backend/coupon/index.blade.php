            ...
            <div class="row">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('coupon.create') }}"> <button class="btn btn-info">Add</button> </a>
                            ...
                            <table class="table table-borderless">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Maximum Discount Amount</th>
                                ...
                                @foreach ($data as $key => $d)
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $d->max_discount }}</td>

                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form action="{{ route('coupon.store') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Value (Flat or Parcent)</label>
                                            <input type="number" name="value"
                                                class="form-control @error('value') is-invalid @enderror"
                                                id="exampleInputEmail1" aria-describedby="emailHelp"
                                                placeholder="Enter the discount value" value="{{ old('value') }}" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="max_discount"
                                                ...
                                                id="exampleInputEmail1" aria-describedby="emailHelp"
                                                placeholder="Enter Maximum Discount Amount" value="{{ old('max_discount') }}" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="expiry_date"
                                                ...
                                                id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ old('expiry_date') }}" />
